...
public class RenameAdminCommand extends ACommand {
	...
	public boolean execute() throws Exception {
		...
		Player renamePlayer = Bukkit.getServer().getPlayer(toRename);
		if (renamePlayer == null || !renamePlayer.isOnline()) {
			throw new CommandException(Lang.getLang("player_not_found"));
		}
		ClanMember retagMember = Clans.getMember(renamePlayer.getUniqueId());
		if (retagMember == null) {
